...
--
-- Hôte : 127.0.0.1
-- Généré le : Dim 17 mai 2020 à 20:32
...
('root', '[{\"db\":\"pole_emploi\",\"table\":\"candidats\"},{\"db\":\"pole_emploi\",\"table\":\"entreprises\"},{\"db\":\"pole_emploi\",\"table\":\"admins\"},{\"db\":\"pole_emploi\",\"table\":\"offres\"},{\"db\":\"test\",\"table\":\"users\"},{\"db\":\"test\",\"table\":\"profiles\"}]');
...
('root', 'pole_emploi', 'candidats', '{\"sorted_col\":\"`candidats`.`cv` ASC\"}', '2020-05-14 18:11:02');
...
('root', '2020-05-17 18:31:27', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\",\"NavigationWidth\":0}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Base de données : `pole_emploi`
--
CREATE DATABASE IF NOT EXISTS `pole_emploi` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pole_emploi`;
...
INSERT INTO `admins` (`id_admin`, `nom_admin`, `email_admin`, `MDP_admin`) VALUES
(1, 'Axel', 'root', 'root');
...
CREATE TABLE `candidats` (
  ...
  `nom_cv` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `candidats` (`id_candidat`, `nom_candidat`, `prenom_candidat`, `mail_candidat`, `MDP_candidat`, `cv`, `nom_cv`) VALUES
(11, 'Boudeau', 'Axel', 'axel.boudeau@ynov.com', 'toto', NULL, NULL);
...
INSERT INTO `entreprises` (`id_entreprise`, `nom_entreprise`, `mail_entreprise`, `MDP_entreprise`) VALUES
(5, 'APB', 'apb@apb.com', 'toto'),
(6, 'RENOVBAT', 'renov@bat.com', 'toto');
...
INSERT INTO `offres` (`id_offre`, `id_entreprise`, `nom_offre`, `description_offre`, `salaire`, `tel`) VALUES
(3, 0, 'PIZZAIOLO', 'faire des pizza', 20400, 909090909),
(6, 0, 'toto', 'aorijojfeqpreqd', 900889, 99789778);
...
--
ALTER TABLE `candidats`
  MODIFY `id_candidat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
INSERT INTO `profiles` (`id`, `age`, `telephone`, `user_id`) VALUES
(1, 23, '0123456789', 1),
(2, 45, '0123456789', 2),
(3, 37, '0123456789', 3),
(4, 23, '0123456789', 1),
